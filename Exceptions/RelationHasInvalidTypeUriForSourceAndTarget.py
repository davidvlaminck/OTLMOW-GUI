...
class RelationHasInvalidTypeUriForSourceAndTarget(Exception):
    """
    ...
    """
    def __init__(self,relation_type_uri,relation_identificator,wrong_field,wrong_value,wrong_field2= None,wrong_value2 = None,*args):
