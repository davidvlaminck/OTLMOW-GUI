...
class RelationExistsForSourceButNotToTypeUriOfTarget(Exception):
    """
    The doelAssetID.typeURI is INVALID for the current relationTypeURI and bronAssetID.typeURI
