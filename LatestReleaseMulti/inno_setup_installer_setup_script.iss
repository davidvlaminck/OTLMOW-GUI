...
#define MyAppName "OTL wizard 2 V0.4.1"
...
OutputBaseFilename=OTL wizard 2 installer V0.4.1
...
begin
  ...
  then
    MsgBox('De installatie van de OTL wizard 2 is geslaagd!' + #13#10 +
...
'Indien u dit wel nodig heeft, moet u de hele installatie opnieuw starten met administrator rechten.' + #13#10 +
